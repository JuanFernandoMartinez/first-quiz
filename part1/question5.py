...
SELECT ANIMALS.NAME, FAVORITE_FOODS.NAME FROM ANIMALS, FAVORITE_FOODS WHERE ANIMALS.FAVORITE_FOOD_ID = FAVORITE_FOODS.FOOD_ID AND FAVORITE_FOODS.VEGETARIAN = 1;
